...
(async function testSignInWrongPasscodes() {
    ...
    try {
        ...
        await driver.findElement(By.id('floating_email')).sendKeys('teste.senhas.incompativeis@gmail.com');
        ...
        await driver.findElement(By.css("input[type='password'][name='floating_email']")).sendKeys('S&UYjVg%e10');
        ...
        console.log(exists);
        if (exists) {
            console.log('UC001-8 test passed.');
        } else {
            console.log('UC001-8 test failed.');
        }
