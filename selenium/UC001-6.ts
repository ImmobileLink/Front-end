...
(async function testSignInNoCRECI() {
    ...
    try {
        ...
        await driver.findElement(By.id('floating_email')).sendKeys('corretor.teste.sem.creci@gmail.com');
        ...
        console.log(exists);
        if (exists) {
            console.log('UC001-6 test passed.');
        } else {
            console.log('UC001-6 test failed.');
        }
