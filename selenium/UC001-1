...
(async function testSignIn() {
    ...
    try {
        ...
        await driver.findElement(By.id('floating_email')).sendKeys('gabriel.s.parreira@gmail.com');
        ...
        const inputData = ['Gabriel Parreira', '41035166835', '81647366000165', '11986391919', '1138951302', '1147020139', '04634020', 'São Paulo', 'Jardim Brasil (Zona Sul)', 'Rua Lacedemônia', '253', 'Apt. 152'];
        ...
        await inputCreci.sendKeys('123456D');
        ...
        let endMessage = await driver.wait(until.elementLocated(By.xpath(`//div[span[text()="Pronto!"]]`)), 10000); // waits up to 10 seconds

        if (endMessage === undefined || endMessage === null) {
            console.error('UC001-1 test failed.');
        } else {
            console.log('UC001-1 test passed.');
        }
