...
(async function testSignInWrongCPF() {
    ...
    try {
        ...
        await driver.findElement(By.id('floating_email')).sendKeys('corretor.teste.cpf.errado@gmail.com');
        ...
        const inputData = ['Corretor Teste CPF Errado', '41035166828', '81647366000162', '11986391919', '1138951302', '1147020139', '04634020', 'São Paulo', 'Jardim Brasil (Zona Sul)', 'Rua Lacedemônia', '253', 'Apt. 152'];
        ...
        console.log(exists);
        if (exists) {
            console.log('UC001-3 test passed.');
        } else {
            console.log('UC001-3 test failed.');
        }
