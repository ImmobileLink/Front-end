...
(async function testVisitPast() {
    ...
    try {
        ...
        const inputData = ['Cliente Fulano Teste', '11986391919', 'fulano.teste.agendamento@gmail.com', '06112022', '1400'];
        ...
        if (buttonClass.includes('group-invalid:pointer-events-none')) {
            ...
            console.log("UC003-3 test passed");
        } else {
            console.log("The button is clickable");
            console.log("UC003-3 test failed");
        }
