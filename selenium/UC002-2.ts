...
(async function testLoginWrongUser() {
    ...
    try {
        ...
        await driver.findElement(By.id('floating_email')).sendKeys('teste.user.nao.cadastrado@gmail.com');
        ...
        if (wrongMessage === undefined || wrongMessage === null) {
            console.error('UC002-2 test failed.');
        } else {
            console.log('UC002-2 test passed.');
        }
