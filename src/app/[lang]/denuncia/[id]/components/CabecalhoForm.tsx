    ...
    return (
        <div className="">
            ...
            <div className="flex flex-col md:pl-8 md:mr-12">
                <div className="flex mb-2 items-baseline  items-baseline ">
                    <input
                        type="radio"
                        value={"Ofensivo"}
                        name={"op"}
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="pl-4 pr-8">
                            ...
                            características protegidas por leis
                            antidiscriminação.
                        </p>
                    </div>
                </div>
                <div className="flex mb-2 items-baseline ">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="pl-4 pr-8">
                            ...
                            gráfico ou que incite atos de abuso e assédio.
                        </p>
                    </div>
                </div>
                <div className="flex mb-2 items-baseline ">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="pl-4 pr-8">
                            Inclui ameaças, chantagens, compartilhamento de
                            conteúdo gráfico perturbador ou ilegal, incentivo ou
                            menção a automutilação e suicídio, discurso violento
                            ou que incentive atos violentos.
                        </p>
                    </div>
                </div>
                <div className="flex mb-2 items-baseline ">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="pl-4 pr-8">
                            ...
                            golpes, organização criminosa ou identidade falsa.
                        </p>
                    </div>
                </div>
                <div className="flex mb-2 items-baseline ">
            ...
            <button className="w-fit text-white bg-gray-500 hover:bg-gray-700 focus:ring-4 font-medium rounded-lg text-sm px-10 py-2.5" onClick={() => router.push('/feed')}>
                CANCELAR
            </button>
            <div className="px-2"/>
            <button
