      ...
      <div className="bg-dark-200 overflow-x-hidden box-border text-black">
        <div className="h-screen w-screen">
          <div className="flex relative max-w-6xl mx-auto px-4 mt-4">
            ...
            <div className="w-2/3 relative  bg-branco mr-3 rounded-md overflow-hidden h-screen">
              <Cabecalho isAssociado={isAssociado} session_data={session_data} corretor={corretor}/>
              <Infos corretor={corretor}/>
            </div>
