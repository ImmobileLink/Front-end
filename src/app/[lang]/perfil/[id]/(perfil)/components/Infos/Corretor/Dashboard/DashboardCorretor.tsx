...
export default function DashboardCorretor({}: DashboardProps) {
          ...
          <div className="absolute flex justify-center items-center inset-0 backdrop-blur-md">
            <div className="w-3/4 flex justify-center flex-col items-center">
              {premium == null ? (
                ...
                <>
                  <p className="text-center font-semibold mb-3">Quer ter acesso a informações mais detalhadas? <br /> Assine nosso plano para corretores</p>
