...
export default async function page({ }: pageProps) {
  ...
  return (
    <>
      <NavBar />
      <div className="bg-dark-200 box-border h-screen text-black">
        <div className="flex justify-center items-center">
          <div className="mt-20 max-w-6xl flex flex-col bg-branco p-5 rounded-md">
            <div className="h-fit grid grid-cols-1 justify-items-center gap-x-32 gap-y-10 md:grid-cols-2">
              ...
              <div className="w-60 h-fit grid justify-items-center gap-3 justify-self-center md:justify-self-start">
                <span className="font-bold text-2xl tracking-wider text-black ">
                  PREMIUM
                </span>
                <div className="bg-gray-400 rounded-full h-60 w-full">
                  {tipoPerfil == 1 ? (
