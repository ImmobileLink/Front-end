  ...
  return (
    <div className="relative mx-auto w-full">
      <div className="shadow p-4 rounded-lg bg-white dark:bg-gray-700 drop-shadow-md">
        <div className="flex justify-center relative rounded-lg overflow-hidden h-48 sm:h-40">
        ...
        <div className="grid grid-cols-2 gap-4 mt-5">
          ...
          <p className="inline-flex flex-col text-gray-800 dark:text-white sm:mb-6">
            <svg
              className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
