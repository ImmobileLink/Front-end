...
const [minSize, setMinSize] = useState(window.matchMedia("(min-width: 768px)"));
...
const colourStyles: StylesConfig = {
  ...
  option: (styles, state) => ({
    ...
    backgroundColor: darkMode.matches ? (state.isFocused && 'rgb(59 130 246)') : (state.isFocused && 'rgb(147 197 253)'),
  }),
  ...
  singleValue: (styles) => ({ ...styles, color: darkMode.matches ? 'white' : 'rgb(55 65 81)', fontSize: minSize.matches ? '0.875rem' : '0.75rem'  }),
  multiValueLabel: (styles) => ({ ...styles, color: 'rgb(55 65 81)', fontSize: minSize.matches ? '0.875rem' : '0.75rem' }),
                    ...
                    <div className="relative w-screen">
                      <div className="fixed h-full w-screen md:max-w-lg top-0 md:right-0 flex-col bg-white dark:bg-dark-200 py-6 shadow-xl overflow-y-auto overflow-x-hidden">
                        <div className="flex px-4 md:px-6 items-center justify-between">
                          ...
                          <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-xs w-8 h-8 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white"
                        ...
                        <div className="px-4 md:px-6 text-xs py-2 mt-2">
                          <span className="text-red-500"> * </span>
                          <span className="text-gray-900 dark:text-white">{props.textos.newproperty.requiredfields}</span>
                        </div>
                        ...
                        <div className="mt-6 flex flex-col px-4 md:px-6">
                                ...
                                <div key={option.id}>
                                  <label>
                                    <input
                                      ...
                                      required
                                    />
                                    <span className="ml-2 text-xs md:text-sm text-gray-700 dark:text-white">{option.descricao}</span> 
                                  </label>
                                </div>
                              ))}
                              </div>
                          ...
                          <div className="-mx-3 md:flex mb-6">
                            <div className="md:w-full px-3">
                              ...
                              />
                              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">PNG, JPG or JPEG (MAX. 800x400px).</p>
                            </div>
                          </div>
                          ...
                          <div className="w-full flex justify-end">
                              <button
                                type="submit"
                                className={`p-2 mt-2 grow text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-10 py-2.5 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition ease-in duration-200 text-center focus:ring-offset-2 group-invalid:pointer-events-none group-invalid:opacity-30 ${(type.id.length === 0) && "pointer-events-none opacity-30"}`}
                              >
                                {loading ? (
                                  <>
                                  <Spinner />
