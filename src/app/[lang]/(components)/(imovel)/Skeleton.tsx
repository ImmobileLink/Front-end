...
export default function Skeleton({ num }: SkeletonProps) {
  return Array(num).fill(0).map((el, index) => (
      <div key={index}>
        <div className="relative bg-gray-100 dark:bg-dark-200 ring-2 ring-gray-300 dark:ring-dark-300 focus:ring-gray-500 focus:ring-2 focus:ring-offset-2 shadow-md rounded-md p-4 align-middle w-full mb-4 animate-pulse">
          <div className="flex justify-center relative rounded-lg overflow-hidden">
            <div className="object-cover my-2 h-48 lg:h-44 rounded-md w-52 flex-none text-center z-0 flex items-center justify-center bg-gray-300 dark:bg-gray-500"></div>
          </div>
