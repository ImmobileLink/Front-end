            ...
            <div className="w-full h-fit flex justify-center align-middle ring-2 ring-gray-300 rounded-md bg-white dark:bg-gray-600 dark:ring-gray-700 drop-shadow-md">
                {userData.id == undefined ? (
                    <div className="flex flex-col align-middle my-4">
                        ...
                        <Link
                            className="flex w-fit self-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                            href={"/auth"}
                            onClick={() => {
                                isLoading(true);
                            }}
                    ...
                    <div className="w-full p-5">
                        <div className="flex justify-center">
                            <Avatar userId={userData.id} size={"big"} />
                        </div>
