...
export default function TypingBox({ idsala, userSession }: TypingBoxProps) {
  ...
  return (
    <>
      <div className="flex items-center px-3 py-2 rounded-lg bg-gray-200 dark:bg-gray-600">
        ...
        <textarea value={texto} onChange={(e) => setTexto(e.target.value)} onKeyDown={handleUserKeyPress} className="block resize-none mx-4 p-2.5 w-full text-xs sm:text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
