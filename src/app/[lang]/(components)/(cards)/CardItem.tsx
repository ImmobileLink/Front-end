...
export default function CardItem({ key, idremetente, iddestinatario, nome, avatardestinatario }: CardItemProps) {
  ...
  return (
    <>
      <div className="flex justify-between mx-6 gap-2 ring-1 ring-gray-800 dark:ring-gray-400 ring-inset rounded-full">
